...
import com.hs.monitor.factory.PageHandlerFactory;
import com.hs.monitor.handlers.HandlerSerial;
...
import static com.hs.monitor.function.MenuFunction.invokeFunction;
...
//        scene.getStylesheets().add(getClass().getResource("/style.css").toExternalForm());
        ...
        //应用名称
        primaryStage.setTitle(getText("title"));
        addLanguageListen("title",primaryStage);
