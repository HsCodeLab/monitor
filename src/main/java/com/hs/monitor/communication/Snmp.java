...
public class Snmp implements Comm {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // SNMP Manager
        org.snmp4j.Snmp snmpManager = new org.snmp4j.Snmp(new DefaultUdpTransportMapping());
        snmpManager.listen();

        // SNMP Agent
        org.snmp4j.Snmp snmpAgent = new org.snmp4j.Snmp(new DefaultUdpTransportMapping());
        snmpAgent.listen();
    ...
    private static void sendSnmpGet(Address targetAddress, String community, String oid, org.snmp4j.Snmp snmp) throws IOException {
    ...
    private static void sendSnmpSet(Address targetAddress, String community, String oid, String value, org.snmp4j.Snmp snmp) throws IOException {
        // Create a PDU for the request
        PDU pdu = new PDU();
    ...
    private static void walkSnmpTree(Address targetAddress, String community, String baseOid, org.snmp4j.Snmp snmp) throws IOException {
        // Create the target
