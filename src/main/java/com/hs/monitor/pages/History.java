package com.hs.monitor.pages;//package com.hs.monitor.pages;
//
...
//        });
//
//        TableView<com.hs.entity.History> tableView = new TableView<>();
...
//                name = name + "(" + unit + ")";
//            }
//            TableColumn<com.hs.entity.History, String> col = new TableColumn<>(name);
//            col.setCellValueFactory(new PropertyValueFactory<>(map.get("prop")));
//            tableView.getColumns().add(col);
//        });
////        ObservableList<com.hs.entity.History> data = FXCollections.observableArrayList(com.hs.entity.History.builder().sn("SN-0001").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0002").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0003").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0004").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0005").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0006").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0007").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0008").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0009").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build(), com.hs.entity.History.builder().sn("SN-0010").voltageInput(220).voltageOutput(220).frequencyInput(50.0).frequencyOutput(50.0).batteryVoltage(48.0).batteryLevel(80).temperature(37).outputLoadPercent(80).build());
//
