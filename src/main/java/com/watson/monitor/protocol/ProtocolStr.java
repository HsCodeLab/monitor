...
import static com.watson.monitor.protocol.ProtocolUtil.getRandom;
import static com.watson.monitor.protocol.ProtocolUtil.protocol_type;
import static com.watson.monitor.utils.ByteUtil.bytesToHex;
...
public class ProtocolStr {
     ...
     * 存储处理函数的map
     */
    public static HashMap<String, WConsumer> function_map = new HashMap<>();
